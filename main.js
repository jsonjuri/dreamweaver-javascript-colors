define(function(require, exports, module) {
    ...
    function tag_color_change() {
        var cmVariables = document.getElementById("editor-holder").querySelectorAll(".cm-variable:not(.cm-javascript), .cm-variable-1:not(.cm-javascript), .cm-variable-2:not(.cm-javascript), .cm-variable-3:not(.cm-javascript)");
